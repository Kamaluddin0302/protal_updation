...
import { Navbar, Slider, AboutCoach,Sidebar, Footer ,Spinner} from "../../Components";
    ...
    firebaseApp.auth().onAuthStateChanged(user => {
      if (user) {
        ...
        if(JSON.parse(user).data.isAdmin){
          this.setState({ loginValue: "Logout", func: "logout",value : "Dashboard" ,looder : false});
